    ...
    <div style="width: 350px; float:none; margin:0 auto" >
        ...
        <form action="/auth/loginProc" method="post">
            <%--<div style="width: 350px; float:none; margin:0 auto" >--%>
                ...
                <br/>
                <%-- todo : 아이디/비밀번호 찾기 기능 추가 필요--%>
                <p><a style="color: black" href="/auth/joinForm">회원가입</a><%-- | <a style="color: black" href="#">아이디/비밀번호 찾기</a>--%></p>
                <div style="text-align: center;">
                    <p style="font-family: Malgun Gothic,dotum,gulim,sans-serif;">──── 소셜 계정으로 간편 로그인 ────</p>
                    <%-- ajax로 로그인 기능 만들어보려다 중단함<img id="oauth2-naver-btn" src="/image/naver_login_btn_원형.png"/>--%>
